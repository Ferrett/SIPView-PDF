    ...
    public partial class PDFSettingsForm : Form
    {
        public PDFSettingsForm()
        {
            ...
            if(PDFViewClass.DoCompression)
            {
                ...
                thumbnailsCheckBox.Checked = PDFViewClass.CompressOptions.IsRemoveImageThumbnailEnabled;
                ...
                metadataCheckBox.Checked = PDFViewClass.CompressOptions.IsRemoveMetadataEnabled;
        ...
        {
            PDFViewClass.CompressOptions = new ImGearCompressOptions()
            {
                IsDownsampleImagesEnabled = downsampleCheckBox.Checked,
                IsRemoveImageThumbnailEnabled = thumbnailsCheckBox.Checked,
                RecompressUsingJpeg2k = jpeg2KRadioButton.Checked,
                RecompressImageJbig2CompressionLevel = (ImGearJbig2CompressionLevel)bitonalComboBox.SelectedIndex,
                RecompressImageJpegCompressionLevel = (ImGearJpegCompressionLevel)jpegComboBox.SelectedIndex,
                RecompressImageJpeg2kCompressionLevel = (ImGearJpeg2kCompressionLevel)jpeg2KComboBox.SelectedIndex,
                IsRemoveMetadataEnabled = metadataCheckBox.Checked,
                IsFieldFlatteningEnabled = flatteringCheckBox.Checked
            };
